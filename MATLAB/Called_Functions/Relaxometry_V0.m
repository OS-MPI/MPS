function [MaxSig_Bucket,MinSig_Bucket,RMag_Output,LMag_Output,MaxSigBias_Bucket,MinSigBias_Bucket] = Relaxometry_V0(Data_Sig,BiasSig,Fd,fs,InterpTF,InterpFactor,Conc,PlotLims)
...
if PlotFinal==1
    ...
    xlabel('External Field(T/\mu_0)')
    xlim([-PlotLims PlotLims])
    legend('Vel. Corrected','Bucket Maxima','Bucket Minima')
    ...
    xlabel('External Field(T/\mu_0)')
    xlim([-PlotLims PlotLims])
    legend('Bucket Maxima','Bucket Minima')
